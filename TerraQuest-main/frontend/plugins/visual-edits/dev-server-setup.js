      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="visual-edit@terraquest.app" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="visual-edit@terraquest.app" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
